...
model = A2C(policy = "MlpPolicy",
            env = env_s,
            gae_lambda = 1.0,#0.99,#0.95,#0.89,#0.8979709455838538,#1.0, #0.117120962797502,
            ...
            max_grad_norm = 2,#0.3,#0.88,#4.565654908777005,#0.5,
            n_steps = 256,#1024,#16,#100,#8,
            vf_coef = 0.93,#0.239,#0.38,#0.51,#0.0024435757218033904,#0.5, # 0.00200901228628941,
            ent_coef = 0.00294,#3.11e-06,#0.00037,#1.0976520036433521e-08,#0.04553259441269758,#0.0,
            policy_kwargs=dict(
...
model.learn(total_timesteps=25000000, callback=HyperParameterCallback())
